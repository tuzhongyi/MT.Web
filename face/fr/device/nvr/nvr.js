        ...
        List: {
            create: function (listId) {
                ...
                for (var a = 0; a < nvrs.length; a++) {
                    ...
                    card.Icon.setIcon("howell-icon-servernetwork");
                    ...
                    card.SetButton.setClick(function (e) {
                        jumpHref.href = navigation.device.nvr.faceset.list + "?deviceId=" + e.currentTarget.elementId + "&type=nvr";
    ...
    Device: {
        ...
        list: function () {
            var result = tryCatch(function () {
                return Client.Management().Device.List(null, null, DeviceClassification.FDNVR, null);
            });
