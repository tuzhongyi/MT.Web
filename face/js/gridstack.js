...
(function (factory) {
    ...
    GridStack.prototype._prepare_element = function (el) {
        ...
        var on_end_moving = function (event, ui) {
            ...
            if (self.opts.afterResize) {
                self.opts.afterResize(node);
            }
        };
    ...
    GridStack.prototype.add_widget = function (el, x, y, width, height, auto_position, min_w, min_h, max_w, max_h, no_move) {
        el = $(el);
        ...
        if (typeof min_w != 'undefined') el.attr('data-gs-min-width', min_w);
        if (typeof min_h != 'undefined') el.attr('data-gs-min-height', min_h);
        if (typeof max_w != 'undefined') el.attr('data-gs-max-width', max_w);
        if (typeof max_h != 'undefined') el.attr('data-gs-max-height', max_h);
        if (typeof no_move != 'undefined') el.attr('data-gs-no-move', no_move);
