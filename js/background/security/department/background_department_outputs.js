...
Html.Control.PopoverWindow["OutputList"] = {
    Common: {
        createItem: function (key, output) {
            var createCoontrol = {
                ...
                AssociationIcon: function (output) {
                    var btn = new IconButton("", "icon-desktop", 11, output.Name);
                    var a = new AlertWindow("", btn, Info.ControlIdPrefix.Output.AlertUrl.details + "?departmentId=" + Html.Current.Id.get() + "&outputId=" + output.Id, -1, true);
                ...
                UnassociationOperationButton: function (output, control) {
                    ...
                    a.href = Info.ControlIdPrefix.Output.AlertUrl.permissions + "?fun=PageEvent.Output.AddOutputToDepartment&departmentId=" + Html.Current.Id.get() + "&outputId=" + output.Id
                    a.setAttribute("onclick", "return GroupListItem_DepartmentUnassociationAddOutput_Click(this, '" + output.Id + "')");
                ...
                AssociationOperationButton: function (output, control) {
                    ...
                    a.setAttribute("onclick", "GroupListItem_DepartmentAssociationRemoveOutput_Click(this, '" + output.Id + "')");
                    ...
                    a.href = Info.ControlIdPrefix.Output.AlertUrl.details + "?departmentId=" + Html.Current.Id.get() + "&outputId=" + output.Id;
            ...
            item = new GroupListItem(Info.ControlIdPrefix.Output[key].list, eval("Department" + key + "Output_Selected"));
        ...
        load: function (key, index) {
            ...
            if (items) {
                ...
                pagination = new Pagination("", page.PageIndex, page.PageSize, page.PageCount, page.RecordCount, page.TotalRecordCount, eval("Department" + key + "Output_PageChange"));
    ...
    Association: {
        ...
        load: function (index) {
            ...
            PageEvent.Department.GroupListOutputIconButtonChanged(Html.Current.Id.get(), Property.OutputList.Association.page.TotalRecordCount);
        },
        clear: function () {
        ...
        remove: function (outputId) {
            ...
            this.clear();
            if (Property.OutputList.Association.page.RecordCount == 1 && Property.OutputList.Association.page.PageIndex == Property.OutputList.Association.page.PageCount &&
        ...
        removeAll: function () {
            ...
            for (var id in Property.OutputList.Association.value) {
                count += Try(function () {
                    Property.OutputList.Association.remove(departmentId, id);
                    return 1;
                }, 0);
            }
            if (Property.OutputList.Association.page.TotalRecordCount != count) {
                Property.OutputList.Association.load(departmentId, 1, Property.OutputList.Association.page.TotalRecordCount);
                for (var id in Property.OutputList.Association.value) {
                    count += Try(function () {
                        Property.OutputList.Association.remove(departmentId, id);
                        return 1;
...
Property["OutputList"] = {
    Association: {
        ...
        load: function (departmentId, index, size) {
            var response = tryCatch(function () {
                return Client.Security().Department.Video.Output.List(departmentId, index, size)
            });
        ...
        remove: function (departmentId, outputId) {
            var result = tryCatch(function () {
                return Client.Security().Department.Video.Output.Delete(departmentId, outputId);
            })
            if (result)
        ...
        get: function (departmentId, outputId) {
            return tryCatch(function () {
                return Client.Security().Department.Video.Output.Get(departmentId, outputId);
            });
        }
    ...
    Unassociation: {
        ...
        load: function (departmentId, index, size) {
            ...
            var response = tryCatch(function () {
                return Client.Security().Department.Video.Output.List(departmentId, index, size, true)
            });
            var result = new Object();
        ...
        add: function (departmentId, output) {
            Client.Security().Department.Video.Output.Create(departmentId, output);
...
PageEvent.Output.AddOutputToDepartment = function (permission, outputId) {
...
PageEvent.Department.ModifyOutputListItem = function (output) {
    Html.Control.PopoverWindow.OutputList.Association.modify(output);
}

PageEvent.Output.BatchAddOutputsToDepartment = function (permission) {
