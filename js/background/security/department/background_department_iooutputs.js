...
Html.Control.PopoverWindow["IOOutputList"] = {
    Common: {
        createItem: function (key, iooutput) {
            var createCoontrol = {
                ...
                AssociationIcon: function (iooutput) {
                    var btn = new IconButton("", "icon-flickr", 11, iooutput.Name);
                    var a = new AlertWindow("", btn, Info.ControlIdPrefix.IOOutput.AlertUrl.details + "?departmentId=" + Html.Current.Id.get() + "&iooutputId=" + iooutput.Id, -1, true);
                ...
                UnassociationOperationButton: function (iooutput, control) {
                    ...
                    a.href = Info.ControlIdPrefix.IOOutput.AlertUrl.permissions + "?fun=PageEvent.IOOutput.AddIOOutputToDepartment&departmentId=" + Html.Current.Id.get() + "&iooutputId=" + iooutput.Id
                    a.setAttribute("onclick", "return GroupListItem_DepartmentUnassociationAddIOOutput_Click(this, '" + iooutput.Id + "')");
                ...
                AssociationOperationButton: function (iooutput, control) {
                    ...
                    a.setAttribute("onclick", "GroupListItem_DepartmentAssociationRemoveIOOutput_Click(this, '" + iooutput.Id + "')");
                    ...
                    a.href = Info.ControlIdPrefix.IOOutput.AlertUrl.details + "?departmentId=" + Html.Current.Id.get() + "&iooutputId=" + iooutput.Id;
            ...
            item = new GroupListItem(Info.ControlIdPrefix.IOOutput[key].list, eval("Department" + key + "IOOutput_Selected"));
        ...
        load: function (key, index) {
            ...
            if (items) {
                ...
                pagination = new Pagination("", page.PageIndex, page.PageSize, page.PageCount, page.RecordCount, page.TotalRecordCount, eval("Department" + key + "IOOutput_PageChange"));
    ...
    Association: {
        ...
        load: function (index) {
            ...
            PageEvent.Department.GroupListIOOutputIconButtonChanged(Html.Current.Id.get(), Property.IOOutputList.Association.page.TotalRecordCount);
        },
        clear: function () {
        ...
        remove: function (iooutputId) {
            ...
            if (Property.IOOutputList.Association.page.RecordCount == 1 && Property.IOOutputList.Association.page.PageIndex == Property.IOOutputList.Association.page.PageCount &&
                Property.IOOutputList.Association.page.PageIndex != 1)
        ...
        batchRemove: function () {
            ...
            if (count == Property.IOOutputList.Association.page.RecordCount && Property.IOOutputList.Association.page.PageIndex == Property.IOOutputList.Association.page.PageCount &&
                Property.IOOutputList.Association.page.PageIndex != 1)
                --Property.IOOutputList.Association.page.PageIndex;
        ...
        removeAll: function () {
            ...
            for (var id in Property.IOOutputList.Association.value) {
                count += Try(function () {
                    Property.IOOutputList.Association.remove(departmentId, id);
                    return 1;
                }, 0);
            }
            if (Property.IOOutputList.Association.page.TotalRecordCount != count) {
                Property.IOOutputList.Association.load(departmentId, 1, Property.IOOutputList.Association.page.TotalRecordCount);
                for (var id in Property.IOOutputList.Association.value) {
                    count += Try(function () {
                        Property.IOOutputList.Association.remove(departmentId, id);
                        return 1;
...
Property["IOOutputList"] = {
    Association: {
        ...
        load: function (departmentId, index, size) {
            var response = tryCatch(function () {
                return Client.Security().Department.IO.Output.List(departmentId, index, size)
            });
        ...
        remove: function (departmentId, iooutputId) {
            var result = tryCatch(function () {
                return Client.Security().Department.IO.Output.Delete(departmentId, iooutputId);
            })
            if (result)
        ...
        get: function (departmentId, iooutputId) {
            return tryCatch(function () {
                return Client.Security().Department.IO.Output.Get(departmentId, iooutputId);
            });
        }
    ...
    Unassociation: {
        ...
        load: function (departmentId, index, size) {
            ...
            var response = tryCatch(function () {
                return Client.Security().Department.IO.Output.List(departmentId, index, size, true)
            });
            var result = new Object();
        ...
        add: function (departmentId, iooutput) {
            Client.Security().Department.IO.Output.Create(departmentId, iooutput);
...
PageEvent.IOOutput.AddIOOutputToDepartment = function (permission, iooutputId) {
...
PageEvent.Department.ModifyIOOutputListItem = function (iooutput) {
    Html.Control.PopoverWindow.IOOutputList.Association.modify(iooutput);
}

PageEvent.IOOutput.BatchAddIOOutputsToDepartment = function (permission) {
