...
Property["Output"] = {
    load: function (departmentId, outputId) {
        return tryCatch(function () {
            return Property.OutputList.Association.get(departmentId, outputId);
        });
    },
    modify: function (output) {
        return tryCatch(function () {
            return Client.Security().Department.Video.Output.Set(Html.Current.Id.get(), output);
        });
    },
}
...
Html.Control.PopoverWindow.OutputList.AlertWindow["Details"] = {
    load: function (departmentId, outputId) {
        var result = Property.Output.load(departmentId, outputId);
        if (result) {
