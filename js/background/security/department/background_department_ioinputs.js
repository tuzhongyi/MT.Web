...
Html.Control.PopoverWindow["IOInputList"] = {
    Common: {
        createItem: function (key, ioinput) {
            var createCoontrol = {
                ...
                AssociationIcon: function (ioinput) {
                    ...
                    var a = new AlertWindow("", btn, Info.ControlIdPrefix.IOInput.AlertUrl.details + "?departmentId=" + Html.Current.Id.get() + "&ioinputId=" + ioinput.Id, -1, true);
                ...
                UnassociationOperationButton: function (ioinput, control) {
                    ...
                    a.href = Info.ControlIdPrefix.IOInput.AlertUrl.permissions + "?fun=PageEvent.IOInput.AddIOInputToDepartment&departmentId=" + Html.Current.Id.get() + "&ioinputId=" + ioinput.Id
                    a.setAttribute("onclick", "return GroupListItem_DepartmentUnassociationAddIOInput_Click(this, '" + ioinput.Id + "')");
                ...
                AssociationOperationButton: function (ioinput, control) {
                    ...
                    a.setAttribute("onclick", "GroupListItem_DepartmentAssociationRemoveIOInput_Click(this, '" + ioinput.Id + "')");
                    ...
                    a.href = Info.ControlIdPrefix.IOInput.AlertUrl.details + "?departmentId=" + Html.Current.Id.get() + "&ioinputId=" + ioinput.Id;
            ...
            item = new GroupListItem(Info.ControlIdPrefix.IOInput[key].list, eval("Department" + key + "IOInput_Selected"));
        ...
        load: function (key, index) {
            ...
            if (items) {
                ...
                pagination = new Pagination("", page.PageIndex, page.PageSize, page.PageCount, page.RecordCount, page.TotalRecordCount, eval("Department" + key + "IOInput_PageChange"));
    ...
    Association: {
        ...
        load: function (index) {
            ...
            PageEvent.Department.GroupListIOInputIconButtonChanged(Html.Current.Id.get(), Property.IOInputList.Association.page.TotalRecordCount);
        },
        clear: function () {
        ...
        removeAll: function () {
            ...
            for (var id in Property.IOInputList.Association.value) {
                count += Try(function () {
                    Property.IOInputList.Association.remove(departmentId, id);
                    return 1;
                }, 0);
            }
            if (Property.IOInputList.Association.page.TotalRecordCount != count) {
                Property.IOInputList.Association.load(departmentId, 1, Property.IOInputList.Association.page.TotalRecordCount);
                for (var id in Property.IOInputList.Association.value) {
                    count += Try(function () {
                        Property.IOInputList.Association.remove(departmentId, id);
                        return 1;
    ...
    Unassociation: {
        ...
        add: function (id, permission) {
            ...
            if (Property.IOInputList.Unassociation.page.RecordCount == 1 && Property.IOInputList.Unassociation.page.PageIndex == Property.IOInputList.Unassociation.page.PageCount && Property.IOInputList.Unassociation.page.PageIndex != 1)
...
Property["IOInputList"] = {
    Association: {
        ...
        load: function (departmentId, index, size) {
            var response = tryCatch(function () {
                return Client.Security().Department.IO.Input.List(departmentId, index, size)
            });
        ...
        remove: function (departmentId, ioinputId) {
            var result = tryCatch(function () {
                return Client.Security().Department.IO.Input.Delete(departmentId, ioinputId);
            })
            if (result)
        ...
        get: function (departmentId, ioinputId) {
            return tryCatch(function () {
                return Client.Security().Department.IO.Input.Get(departmentId, ioinputId);
            });
            //    if (response)
            //    {
    ...
    Unassociation: {
        ...
        load: function (departmentId, index, size) {
            ...
            var response = tryCatch(function () {
                return Client.Security().Department.IO.Input.List(departmentId, index, size, true)
            });
            var result = new Object();
        ...
        add: function (departmentId, ioinput) {
            Client.Security().Department.IO.Input.Create(departmentId, ioinput);
...
PageEvent.IOInput.AddIOInputToDepartment = function (permission, ioinputId) {
...
PageEvent.Department.ModifyIOInputListItem = function (ioinput) {
    Html.Control.PopoverWindow.IOInputList.Association.modify(ioinput);
}

PageEvent.IOInput.BatchAddIOInputsToDepartment = function (permission) {
