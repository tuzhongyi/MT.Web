...
Property["Device"] = {
    load: function (departmentId,deviceId) {
        return tryCatch(function () {
            return Property.DeviceList.Association.get(departmentId, deviceId);
        });
    },
    modify: function (device) {
        return tryCatch(function () {
            return Client.Security().Department.Device.Set(Html.Current.Id.get(), device);
        });
    },
}
...
Html.Control.PopoverWindow.DeviceList.AlertWindow["Details"] = {
    load: function (departmentId, deviceId) {
        var result = Property.Device.load(departmentId, deviceId);
