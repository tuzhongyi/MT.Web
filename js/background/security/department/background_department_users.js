...
Property["UserList"] =
{
    Association: {
        ...
        load: function (departmentId, index, size) {
            var response = tryCatch(function () {
                return Client.Security().Department.User.List(departmentId, index, size)
            });
        ...
        remove: function (departmentId, userId) {
            var result = tryCatch(function () {
                return Client.Security().Department.User.Delete(departmentId, userId);
            })
            if (result)
    ...
    Unassociation: {
        ...
        load: function (departmentId, index, size) {
            ...
            var response = tryCatch(function () {
                return Client.Security().Department.User.List(departmentId, index, size, null, true)
            });
            var result = new Object();
        ...
        add: function (departmentId, userId) {
            Client.Security().Department.User.Association(departmentId, userId);
            delete this.value[userId];
...
Html.Control.PopoverWindow["UserList"] = {
    Common: {
        createItem: function (key, user) {
            var createCoontrol = {
                ...
                UnassociationOperationButton: function (user) {
                    ...
                    a.setAttribute("onclick", "GroupListItem_DepartmentUnassociationAddUser_Click(this, '" + user.Id + "')");
                ...
                AssociationOperationButton: function (user) {
                    ...
                    a.setAttribute("onclick", "GroupListItem_DepartmentAssociationRemoveUser_Click(this, '" + user.Id + "')");
            ...
            item = new GroupListItem(Info.ControlIdPrefix.User[key].list, eval("Department" + key + "User_Selected"));
        ...
        load: function (key, index) {
            ...
            if (items) {
                ...
                pagination = new Pagination("", page.PageIndex, page.PageSize, page.PageCount, page.RecordCount, page.TotalRecordCount, eval("Department" + key + "User_PageChange"));
    ...
    Association: {
        ...
        load: function (index) {
            ...
            PageEvent.Department.GroupListUserIconButtonChanged(Html.Current.Id.get(), Property.UserList.Association.page.TotalRecordCount);
        },
        clear: function () {
        ...
        removeAll: function () {
            ...
            for (var id in Property.UserList.Association.value) {
                count += Try(function () {
                    Property.UserList.Association.remove(departmentId, id);
                    return 1;
                }, 0);
            }
            if (Property.UserList.Association.page.TotalRecordCount != count) {
                Property.UserList.Association.load(departmentId, 1, Property.UserList.Association.page.TotalRecordCount);
                for (var id in Property.UserList.Association.value) {
                    count += Try(function () {
                        Property.UserList.Association.remove(departmentId, id);
                        return 1;
    ...
    Unassociation: {
        ...
        add: function (id) {
            Property.UserList.Unassociation.add(Html.Current.Id.get(), id);
        ...
        batchAdd: function () {
            for (var i = 0; i < this.selected.length; i++) {
                try {
                    Property.UserList.Unassociation.add(Html.Current.Id.get(), this.selected[i]);
                } catch (e) {
