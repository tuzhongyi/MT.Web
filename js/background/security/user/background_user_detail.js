...
Html.Control["AlertWindow"] = {
    ...
    create: function (user) {
        ...
        Html.Control.GroupList.load(1, Property.PageSize * LazyLoadPage.PageIndex, Property.UserPermission);

    },
    modify: function (user) {
        Property.User.modify(user);
        AlertWindow.Close(Html.Control.GroupList.modify, user);
    },
    IsModify:
    {
        value: false,
        ...
        set: function (value) {
            ...
            if (value) {
                title = "设置用户";
                getTag("divPassword").style.display = "none";
                getTag("divConfirmPassword").style.display = "none";
            }
