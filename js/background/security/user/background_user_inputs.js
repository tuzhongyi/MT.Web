...
Html.Control.PopoverWindow["InputList"] = {
    Common: {
        createItem: function (key, input) {
            var createCoontrol = {
                ...
                AssociationIcon: function (input) {
                    ...
                    var a = new AlertWindow("", btn, Info.ControlIdPrefix.Input.AlertUrl.details + "?userId=" + Html.Current.Id.get() + "&inputId=" + input.Id, -1, true);
                ...
                UnassociationOperationButton: function (input, control) {
                    ...
                    a.href = Info.ControlIdPrefix.Input.AlertUrl.permissions + "?fun=PageEvent.Input.AddInputToUser&userId=" + Html.Current.Id.get() + "&inputId=" + input.Id
                    a.setAttribute("onclick", "return GroupListItem_UserUnassociationAddInput_Click(this, '" + input.Id + "')");
                ...
                AssociationOperationButton: function (input, control) {
                    ...
                    a.setAttribute("onclick", "GroupListItem_UserAssociationRemoveInput_Click(this, '" + input.Id + "')");
                    ...
                    a.href = Info.ControlIdPrefix.Input.AlertUrl.details + "?userId=" + Html.Current.Id.get() + "&inputId=" + input.Id;
            ...
            item = new GroupListItem(Info.ControlIdPrefix.Input[key].list, eval("User" + key + "Input_Selected"));
        ...
        load: function (key, index) {
            ...
            if (items) {
                ...
                pagination = new Pagination("", page.PageIndex, page.PageSize, page.PageCount, page.RecordCount, page.TotalRecordCount, eval("User" + key + "Input_PageChange"));
    ...
    Association: {
        ...
        load: function (index) {
            ...
            PageEvent.User.GroupListInputIconButtonChanged(Html.Current.Id.get(), Property.InputList.Association.page.TotalRecordCount);
        },
        clear: function () {
        ...
        batchRemove: function () {
            ...
            if (count == Property.InputList.Association.page.RecordCount && Property.InputList.Association.page.PageIndex == Property.InputList.Association.page.PageCount && Property.InputList.Association.page.PageIndex != 1)
                --Property.InputList.Association.page.PageIndex;
        ...
        removeAll: function () {
            ...
            for (var id in Property.InputList.Association.value) {
                count += Try(function () {
                    Property.InputList.Association.remove(userId, id);
                    return 1;
                }, 0);
            }
            if (Property.InputList.Association.page.TotalRecordCount != count) {
                Property.InputList.Association.load(userId, 1, Property.InputList.Association.page.TotalRecordCount);
                for (var id in Property.InputList.Association.value) {
                    count += Try(function () {
                        Property.InputList.Association.remove(userId, id);
                        return 1;
...
Property["InputList"] = {
    Association: {
        ...
        load: function (userId, index, size) {
            var response = tryCatch(function () {
                return Client.Security().User.Video.Input.List(userId, index, size)
            });
        ...
        remove: function (userId, inputId) {
            var result = tryCatch(function () {
                return Client.Security().User.Video.Input.Delete(userId, inputId);
            })
            if (result)
        ...
        get: function (userId, inputId) {
            return tryCatch(function () {
                return Client.Security().User.Video.Input.Get(userId, inputId);
            });
            //    if (response)
            //    {
    ...
    Unassociation: {
        ...
        load: function (userId, index, size) {
            ...
            var response = tryCatch(function () {
                return Client.Security().User.Video.Input.List(userId, index, size, true)
            });
            var result = new Object();
        ...
        add: function (userId, input) {
            Client.Security().User.Video.Input.Create(userId, input);
...
PageEvent.Input.AddInputToUser = function (permission, inputId) {
...
PageEvent.User.ModifyInputListItem = function (input) {
    Html.Control.PopoverWindow.InputList.Association.modify(input);
}

PageEvent.Input.BatchAddInputsToUser = function (permission) {
