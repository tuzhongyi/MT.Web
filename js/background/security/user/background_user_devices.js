...
Html.Control.PopoverWindow["DeviceList"] = {
    Common: {
        createItem: function (key, device) {
            var createCoontrol = {
                ...
                AssociationIcon: function (device) {
                    ...
                    var a = new AlertWindow("", btn, Info.ControlIdPrefix.Device.AlertUrl.details + "?userId=" + Html.Current.Id.get() + "&deviceId=" + device.Id, -1, true);
                    a.title = device.Name;
                ...
                UnassociationOperationButton: function (device, control) {
                    ...
                    a.href = Info.ControlIdPrefix.Device.AlertUrl.permissions + "?fun=PageEvent.Device.AddDeviceToUser&userId=" + Html.Current.Id.get() + "&deviceId=" + device.Id
                    a.setAttribute("onclick", "return GroupListItem_UserUnassociationAddDevice_Click(this, '" + device.Id + "')");
                ...
                AssociationOperationButton: function (device, control) {
                    ...
                    a.setAttribute("onclick", "GroupListItem_UserAssociationRemoveDevice_Click(this, '" + device.Id + "')");
                    ...
                    a.href = Info.ControlIdPrefix.Device.AlertUrl.details + "?userId=" + Html.Current.Id.get() + "&deviceId=" + device.Id;
            ...
            item = new GroupListItem(Info.ControlIdPrefix.Device[key].list, eval("User" + key + "Device_Selected"));
        ...
        load: function (key, index) {
            ...
            if (items) {
                ...
                pagination = new Pagination("", page.PageIndex, page.PageSize, page.PageCount, page.RecordCount, page.TotalRecordCount, eval("User" + key + "Device_PageChange"));
    ...
    Association: {
        ...
        load: function (index) {
            ...
            PageEvent.User.GroupListDeviceIconButtonChanged(Html.Current.Id.get(), Property.DeviceList.Association.page.TotalRecordCount);
        },
        clear: function () {
        ...
        batchRemove: function () {
            ...
            if (count == Property.DeviceList.Association.page.RecordCount && Property.DeviceList.Association.page.PageIndex == Property.DeviceList.Association.page.PageCount &&
                Property.DeviceList.Association.page.PageIndex != 1)
                --Property.DeviceList.Association.page.PageIndex;
        ...
        removeAll: function () {
            ...
            for (var id in Property.DeviceList.Association.value) {
                count += Try(function () {
                    Property.DeviceList.Association.remove(userId, id);
                    return 1;
                }, 0);
            }
            if (Property.DeviceList.Association.page.TotalRecordCount != count) {
                Property.DeviceList.Association.load(userId, 1, Property.DeviceList.Association.page.TotalRecordCount);
                for (var id in Property.DeviceList.Association.value) {
                    count += Try(function () {
                        Property.DeviceList.Association.remove(userId, id);
                        return 1;
...
Property["DeviceList"] = {
    Association: {
        ...
        load: function (userId, index, size) {
            var response = tryCatch(function () {
                return Client.Security().User.Device.List(userId, index, size)
            });
        ...
        remove: function (userId, deviceId) {
            var result = tryCatch(function () {
                return Client.Security().User.Device.Delete(userId, deviceId);
            })
            if (result)
        ...
        get: function (userId, deviceId)
        {
            return tryCatch(function () {
                return Client.Security().User.Device.Get(userId, deviceId);
            });
        }
    ...
    Unassociation: {
        ...
        load: function (userId, index, size) {
            ...
            var response = tryCatch(function () {
                return Client.Security().User.Device.List(userId, index, size, true)
            });
            var result = new Object();
        ...
        add: function (userId, device) {
            Client.Security().User.Device.Create(userId, device);
...
PageEvent.Device.AddDeviceToUser = function (permission, deviceId) {
...
PageEvent.User.ModifyDeviceListItem = function (device) {
    Html.Control.PopoverWindow.DeviceList.Association.modify(device);
}

PageEvent.Device.BatchAddDevicesToUser = function (permission) {
