    ...
    ControlIdPrefix:
    {
        ...
        Video: {
            ...
            Output: {
                ...
                display:"device_video_output_list_display_",
                AlertUrl: {
                    ...
                    display: "management/device/video/output/decoding/display_set.htm"
                },
                Jump: {
            ...
            createItem: function (device) {
                ...
                var createControl = {
                    ...
                    details: function (device, control) {
                        ...
                        btn.href = "management/device/device_details.htm?deviceId=" + device.Id;
                    ...
                    edit: function (device, control) {
                        var btn = document.createElement("div");
                        btn.appendChild($("<a title=\"编辑\" id='" + Info.ControlIdPrefix.Edit + device.Id + "' href=\"management/device/device_details.htm?deviceId=" + device.Id + "\" class=\"table-actions expand-btn\" onclick=\"return editDevice_Click(this)\"><i class=\"icon-edit\"></i></a>")[0]);
                        btn.className = "pull-right list-lable-btn-operation";
                        control.appendChild(btn);
                    },
                    //云控件
                    ...
                    statistics: function (device, control) {
                        ...
                        //a.appendChild(i);
                        //btn.appendChild(a);
                        btn.appendChild($("<a title=\"统计\" href=\"management/device/device_statistics.htm?deviceId=" + device.Id + "\" onclick=\"return toStatistics_Click(this,'" + device.Id + "')\" class=\"table-actions expand-btn\"><i class=\"icon-bar-chart\"></i></a>")[0]);
                        btn.className = "pull-right list-lable-btn-operation";
                        control.appendChild(btn);
                    },
                    //无线控件
