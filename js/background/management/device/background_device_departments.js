...
Property["DepartmentList"] =
{
    Association: {
        ...
        load: function (deviceId, index, size) {
            var response = tryCatch(function () {
                return Client.Security().Permission.Device.Departments.List(deviceId, index, size)
            });
        ...
        remove: function (deviceId, departmentId) {
            var result = tryCatch(function () {
                return Client.Security().Permission.Device.Departments.Delete(deviceId, departmentId);
            })
            if (result)
    ...
    Unassociation: {
        ...
        load: function (deviceId, index, size) {
            var response = tryCatch(function () {
                return Client.Security().Permission.Device.Departments.List(deviceId, index, size, true);
            });
            var result = new Object();
        ...
        add: function (deviceId, departmentId, permission) {
            ...
            Client.Security().Department.Device.Create(departmentId, devicePermission);
            delete this.value[departmentId];
...
Html.Control.PopoverWindow["DepartmentList"] = {
    Common: {
        createItem: function (key, department) {
            var createCoontrol = {
                ...
                UnassociationOperationButton: function (department) {
                    ...
                    a.href = Info.ControlIdPrefix.Department.AlertUrl.permissions + "?fun=PageEvent.Device.Department.AddDepartmentToDevice&deviceId=" + Html.Current.Id.get() + "&departmentId=" + department.Id
                    a.setAttribute("onclick", "return GroupListItem_DeviceUnassociationAddDepartment_Click(this, '" + department.Id + "')");
                ...
                AssociationOperationButton: function (department) {
                    ...
                    a.setAttribute("onclick", "GroupListItem_DeviceAssociationRemoveDepartment_Click(this, '" + department.Id + "')");
            ...
            item = new GroupListItem(Info.ControlIdPrefix.Department[key].list, eval("Device" + key + "Department_Selected"));
        ...
        load: function (key, index) {
            ...
            if (items) {
                ...
                pagination = new Pagination("", page.PageIndex, page.PageSize, page.PageCount, page.RecordCount, page.TotalRecordCount, eval("Device" + key + "Department_PageChange"));
    ...
    Association: {
        ...
        load: function (index) {
            ...
            PageEvent.Device.GroupListDepartmentIconButtonChanged(Html.Current.Id.get(), Property.DepartmentList.Association.page.TotalRecordCount);
        },
        clear: function () {
        ...
        removeAll: function () {
            ...
            for (var id in Property.DepartmentList.Association.value) {
                count += Try(function () {
                    Property.DepartmentList.Association.remove(deviceId, id);
                    return 1;
                }, 0);
            }
            if (Property.DepartmentList.Association.page.TotalRecordCount != count) {
                Property.DepartmentList.Association.load(deviceId, 1, Property.DepartmentList.Association.page.TotalRecordCount);
                for (var id in Property.DepartmentList.Association.value) {
                    count += Try(function () {
                        Property.DepartmentList.Association.remove(deviceId, id);
                        return 1;
    ...
    Unassociation: {
        ...
        add: function (id, permission) {
            Property.DepartmentList.Unassociation.add(Html.Current.Id.get(), id, permission);

            if (Property.DepartmentList.Unassociation.page.RecordCount == 1 && Property.DepartmentList.Unassociation.page.PageIndex == Property.DepartmentList.Unassociation.page.PageCount && Property.DepartmentList.Unassociation.page.PageIndex != 1)
        ...
        batchAdd: function (permission) {
            for (var i = 0; i < this.selected.length; i++) {
                try {
                    Property.DepartmentList.Unassociation.add(Html.Current.Id.get(), this.selected[i], permission);
                } catch (e) {
...
PageEvent.Device.Department.AddDepartmentToDevice = function (permission, departmentId) {
...
PageEvent.Device.Department.BatchAddDepartmentsToDevice = function (permission) {
