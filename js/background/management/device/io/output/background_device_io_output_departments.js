...
Property["DepartmentList"] =
{
    Association: {
        ...
        load: function (outputId, index, size) {
            var response = tryCatch(function () {
                return Client.Security().Permission.IO.Output.Department.List(outputId, index, size)
            });
        ...
        remove: function (outputId, departmentId) {
            var result = tryCatch(function () {
                return Client.Security().Permission.IO.Output.Department.Delete(outputId, departmentId);
            })
            if (result)
    ...
    Unassociation: {
        ...
        load: function (outputId, index, size) {
            var response = tryCatch(function () {
                return Client.Security().Permission.IO.Output.Department.List(outputId, index, size, true);
            });
            var result = new Object();
        ...
        add: function (outputId, departmentId, permission) {
            ...
            Client.Security().Department.IO.Output.Create(departmentId, iooutputChannelPermission);
            delete this.value[departmentId];
...
Html.Control.PopoverWindow["DepartmentList"] = {
    Common: {
        createItem: function (key, department) {
            var createCoontrol = {
                ...
                UnassociationOperationButton: function (department) {
                    ...
                    a.href = "output/department/" + Property.Location.Department.Details.Value + "?fun=PageEvent.Device.IO.Output.Department.AddDepartmentToOutput&outputId=" + Html.Control.AlertWindow.Device.Output.Details.get().Id + "&departmentId=" + department.Id
                    a.setAttribute("onclick", "return GroupListItem_IOOutputUnassociationAddDepartment_Click(this, '" + department.Id + "')");
                    a.id = Info.ControlIdPrefix.Device.IO.Output.Department.Unassociation.add + department.Id;
                    a.title = "添加";
                    return a;
                },
                AssociationOperationButton: function (department) {
                    ...
                    a.setAttribute("onclick", "GroupListItem_IOOutputAssociationRemoveDepartment_Click(this, '" + department.Id + "')");
                    a.id = Info.ControlIdPrefix.Device.IO.Output.Department.Association.remove + department.Id;
                    a.title = "删除";
                    return a;
                },
            ...
            item = new GroupListItem(Info.ControlIdPrefix.Device.IO.Output.Department[key].list, eval("IOOutput" + key + "Department_Selected"));
            item.id = Info.ControlIdPrefix.Device.IO.Output.Department[key].list + department.Id;
        ...
        load: function (key, index) {
            ...
            if (items) {
                ...
                pagination = new Pagination("", page.PageIndex, page.PageSize, page.PageCount, page.RecordCount, page.TotalRecordCount, eval("IOOutput" + key + "Department_PageChange"));
    ...
    Association: {
        ...
        selectInverse: function () {
            Property.DepartmentList.Association.load(Html.Control.AlertWindow.Device.Output.Details.get().Id);
            for (var uid in Property.DepartmentList.Association.value) {
                var tag = getTag(Info.ControlIdPrefix.Device.IO.Output.Department.Association.list + uid);
        ...
        load: function (index) {
            ...
            PageEvent.Device.IO.Output.GroupListDepartmentIconButtonChanged(Html.Control.AlertWindow.Device.Output.Details.get().Id, Property.DepartmentList.Association.page.TotalRecordCount);
        },
        clear: function () {
    ...
    Unassociation: {
        ...
        selectInverse: function () {
            Property.DepartmentList.Unassociation.load(Html.Control.AlertWindow.Device.Output.Details.get().Id);
            for (var uid in Property.DepartmentList.Unassociation.value) {
                var tag = getTag(Info.ControlIdPrefix.Device.IO.Output.Department.Unassociation.list + uid);
...
PageEvent.Device.IO.Output.Department.AddDepartmentToOutput = function (permission, departmentId) {
...
PageEvent.Device.IO.Output.Department.BatchAddOutputsToDepartment = function (permission) {
