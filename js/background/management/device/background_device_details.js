...
Html.Control["AlertWindow"] = {
    ...
    load: function (id) {
        ...
        this.ProtocolType.set(result.ProtocolType, result.Classification);
    ...
    ProtocolType: {
        set: function (value, classification) {
            if (hasCapabilitiesDevice[classification]) {
                detailClassification_Onchange(getTag("ddlDetailClassification"));
                getTag("ddlProtocolType").value = value;
            }
            else {
                getTag("txtProtocolType").value = value;
                getTag("divTxtProtocolType").style.display = "block";
                getTag("divDdlProtocolType").style.display = "none";
            }
        }
    },
    BusAddress: {
