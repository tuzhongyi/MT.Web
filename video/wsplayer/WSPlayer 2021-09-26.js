function WSPlayer (args) {
  ...
  function initTools () {
    ...
    that.tools.event.control.volume.slide.input = function () {
      if (that.status == wsPlayerState.ready)
        return;
