...
(function ($) {
    ...
    */
    $.confirm = function (options, e) {
        ...
        if (settings.top > 0)
            modal.find(".modal-dialog").css("padding-top", settings.top + "px");
        ...
        setTimeout(function () {
            ...
            if (settings.top < 0) {
                ...
                modal.find(".modal-dialog").css("padding-top", top + "px");
            }
        ...
        modal[0].onclick = function () {
            ...
            try {
                ...
                if (evt.stopPropagation) { //W3C×èÖ¹Ã°ÅÝ·½·¨  
                    evt.stopPropagation();
                } else {
                    evt.cancelBubble = true; //IE×èÖ¹Ã°ÅÝ·½·¨  
                }
                return false;
            }
            finally {
