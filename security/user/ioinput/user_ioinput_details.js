//完成按钮
function btnDetailUser_IOInput_Click(sender, args) {
    ...
    AlertWindow.Close(PageEvent.User.ModifyIOInputListItem, ioinput);
}
function user_ioinput_detail_load(sender, args) {
