//完成按钮
function btnDetailDepartment_IOOutput_Click(sender, args) {
    ...
    AlertWindow.Close(PageEvent.Department.ModifyIOOutputListItem, iooutput);
}
function department_iooutput_detail_load(sender, args) {
