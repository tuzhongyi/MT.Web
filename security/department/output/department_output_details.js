//完成按钮
function btnDetailDepartment_Output_Click(sender, args) {
    ...
    AlertWindow.Close(PageEvent.Department.ModifyOutputListItem, output);
}
function department_output_detail_load(sender, args) {
